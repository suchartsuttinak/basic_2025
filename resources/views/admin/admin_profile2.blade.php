                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="minmax-datepicker"
                                                placeholder="Mindate - Maxdate">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">MinDate</label>
                                            <input type="text" class="form-control" id="mindate-datepicker"
                                                placeholder="Mindate">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">MaxDate</label>
                                            <input type="text" class="form-control" id="maxdate-datepicker"
                                                placeholder="Maxdate">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Today</label>
                                            <input type="text" class="form-control" id="today-datepicker"
                                                placeholder="Today">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Today to maximum day</label>
                                            <input type="text" class="form-control" id="todaymax-datepicker"
                                                placeholder="Today to maximum day">
                                        </div>

                                        <div>
                                            <label class="form-label">Disabling dates</label>
                                            <input type="text" class="form-control" id="disable-datepicker"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="disablefunction-datepicker"
                                                placeholder="Disabling by functions">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Selecting multiple dates</label>
                                            <input type="text" class="form-control" id="multipledates-datepicker"
                                                placeholder="Selecting multiple dates">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Selecting multiple conjunction</label>
                                            <input type="text" class="form-control" id="multipleconjunction-datepicker"
                                                placeholder="Selecting multiple conjunction">
                                        </div>

                                        <div class="mb-3">
                                            <label class="form-label">Range Calendar</label>
                                            <input type="text" class="form-control" id="rangecalendar-datepicker"
                                                placeholder="Range Calendar">
                                        </div>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <input id="24hours-timepicker" type="text" class="form-control"
                                                placeholder="24-hour Time Picker">
                                        </div>
                                    </div>
